...
set CLASSPATH=%APP_HOME%\lib\excelMergeTool-0.1.0.jar;%APP_HOME%\lib\poi-ooxml-3.9.jar;%APP_HOME%\lib\poi-3.9.jar;%APP_HOME%\lib\poi-ooxml-schemas-3.9.jar;%APP_HOME%\lib\dom4j-1.6.1.jar;%APP_HOME%\lib\groovy-ant-2.5.7.jar;%APP_HOME%\lib\groovy-cli-commons-2.5.7.jar;%APP_HOME%\lib\groovy-groovysh-2.5.7.jar;%APP_HOME%\lib\groovy-console-2.5.7.jar;%APP_HOME%\lib\groovy-groovydoc-2.5.7.jar;%APP_HOME%\lib\groovy-docgenerator-2.5.7.jar;%APP_HOME%\lib\groovy-cli-picocli-2.5.7.jar;%APP_HOME%\lib\groovy-datetime-2.5.7.jar;%APP_HOME%\lib\groovy-jmx-2.5.7.jar;%APP_HOME%\lib\groovy-json-2.5.7.jar;%APP_HOME%\lib\groovy-jsr223-2.5.7.jar;%APP_HOME%\lib\groovy-macro-2.5.7.jar;%APP_HOME%\lib\groovy-nio-2.5.7.jar;%APP_HOME%\lib\groovy-servlet-2.5.7.jar;%APP_HOME%\lib\groovy-sql-2.5.7.jar;%APP_HOME%\lib\groovy-swing-2.5.7.jar;%APP_HOME%\lib\groovy-templates-2.5.7.jar;%APP_HOME%\lib\groovy-test-2.5.7.jar;%APP_HOME%\lib\groovy-test-junit5-2.5.7.jar;%APP_HOME%\lib\groovy-testng-2.5.7.jar;%APP_HOME%\lib\groovy-xml-2.5.7.jar;%APP_HOME%\lib\groovy-2.5.7.jar;%APP_HOME%\lib\commons-codec-1.5.jar;%APP_HOME%\lib\xmlbeans-2.3.0.jar;%APP_HOME%\lib\xml-apis-1.0.b2.jar;%APP_HOME%\lib\ant-junit-1.9.13.jar;%APP_HOME%\lib\ant-1.9.13.jar;%APP_HOME%\lib\ant-launcher-1.9.13.jar;%APP_HOME%\lib\ant-antlr-1.9.13.jar;%APP_HOME%\lib\commons-cli-1.4.jar;%APP_HOME%\lib\picocli-3.9.5.jar;%APP_HOME%\lib\qdox-1.12.1.jar;%APP_HOME%\lib\jline-2.14.6.jar;%APP_HOME%\lib\junit-4.12.jar;%APP_HOME%\lib\junit-platform-launcher-1.4.0.jar;%APP_HOME%\lib\junit-jupiter-engine-5.4.0.jar;%APP_HOME%\lib\testng-6.13.1.jar;%APP_HOME%\lib\stax-api-1.0.1.jar;%APP_HOME%\lib\hamcrest-core-1.3.jar;%APP_HOME%\lib\junit-platform-engine-1.4.0.jar;%APP_HOME%\lib\junit-jupiter-api-5.4.0.jar;%APP_HOME%\lib\junit-platform-commons-1.4.0.jar;%APP_HOME%\lib\apiguardian-api-1.0.0.jar;%APP_HOME%\lib\jcommander-1.72.jar;%APP_HOME%\lib\opentest4j-1.1.1.jar
